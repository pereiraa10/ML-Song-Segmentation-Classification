...
<i>**Fig. 1.** Extracted tempo in BPM per audio sample in the training dataset.</i>
...
<i>**Fig. 2.** Extracted tempo in BPM and classifier prediction from the SVM model</i>
